import { Card, CardBody, CardFooter, Image, Text, Stack, ButtonGroup, Button, HStack, Tag, Link, useToast, LinkBox, LinkOverlay } from '@chakra-ui/react'
            ...
            <Card maxW='xs' variant='outline' bg='discord.700' boxShadow={boxShadowStyle.boxShadow}>
                <CardBody padding='0px'>
                    ...
                    <Stack spacing='3' p={3}>
                        ...
                        <HStack>
                            ...
                            <Tag bg='discord.100' color='white'>+{bot.tags.length - 2}</Tag>
                        </HStack>
                ...
                <CardFooter p={1} >
                    <ButtonGroup spacing='1'>
                        <Button variant='outline' colorScheme='blue' size='sm' onClick={gotoDetail}>
                            View
                        </Button>
                        <Button variant='outline' colorScheme='blue' size='sm'>
                            <LinkOverlay href={sharedBot.curBot.inviteLink}>Invite</LinkOverlay>
                        </Button>
                        <Button variant='outline' colorScheme='blue' size='sm' onClick={upVote}>
                            Upvote
                        </Button>
                    </ButtonGroup>
                </CardFooter>
